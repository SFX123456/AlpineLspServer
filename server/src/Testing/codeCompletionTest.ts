...
function testing()
{
    ...
    const message  = '{"jsonrpc":"2.0","id":2,"method":"textDocument/completion","params":{"textDocument":{"uri":"file:///e%3A/fsd/test.txt"},"position":{"line":3,"character":20},"context":{"triggerKind":1}}}'
