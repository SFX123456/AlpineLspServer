...
function testing()
{
    ...
    const uri = "file:///e%3A/fsd/test.txt"
    ...
    const message  = '{"jsonrpc":"2.0","id":2,"method":"textDocument/completion","params":{"textDocument":{"uri":"file:///e%3A/fsd/test.txt"},"position":{"line":10,"character":27},"context":{"triggerKind":1}}}'
    ...
    async function test()
    {
        ...
        const res = await completion(messageParsed)
        //console.log(res)
...
export function setUpEnvironmentForTesting()
{
    Log.activateConsoleLog()
}
